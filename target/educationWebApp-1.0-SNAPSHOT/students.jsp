    ...
    if ("POST".equals(request.getMethod())) {
        if ("delete".equals(action)) {
            ...
            try {
                ...
                msg = "Tələbə məlumatları yeniləndi.";
                msgType = "success";
                response.sendRedirect("students.jsp");
            } catch (Exception e) {
                msg = "Xəta: " + e.getMessage();
...
<head>
    ...
    <title>Tələbələr - Education App</title>
...
<div id="loader">
    <div class="loader-content">
        ...
        <div class="loader-circle"></div>
        <div class="loader-circle"></div>
        <div class="loader-subtext">Tələbə səyfəsi yüklənir...</div>
    </div>
</div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-6 col-xl-3" data-aos="fade-up" data-aos-delay="0">
                <div class="stat-card-modern primary-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-label">Cəmi Tələbə</span>
            ...
            <div class="col-6 col-xl-3" data-aos="fade-up" data-aos-delay="200">
                <div class="stat-card-modern warning-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-label">Məzunlar</span>
            ...
            <div class="col-6 col-xl-3" data-aos="fade-up" data-aos-delay="300">
                <div class="stat-card-modern danger-card">
                    ...
                    <div class="stat-info">
                        <span class="stat-label">Ortalama Qiymət</span>
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="50">
                <div class="student-analytics-card student-distribution-card">
                    <div class="student-card-head">
                        <h5 class="mb-1">Tələbə Paylanması</h5>
                        <span class="student-card-note">Cari bölgü</span>
                    </div>
                    <div class="student-distribution-wrap">
                        ...
                        <div class="student-distribution-legend">
                            ...
                            <div class="distribution-item"><span
                                    class="distribution-dot dot-green"></span><span>Məzun <strong><%= graduatedStudents %></strong></span>
                            </div>
                            <div class="distribution-item"><span class="distribution-dot dot-orange"></span><span>Digər aktiv <strong><%= passiveStudents %></strong></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
                <div class="student-analytics-card student-performance-card">
                    <div class="student-card-head">
                        ...
                        <span class="student-card-note">Qiymət, iştirak və ireliləyiş</span>
                    </div>
                    <div class="student-performance-legend">
                        <span><i class="bi bi-square-fill text-primary"></i> Qiymət</span>
                        <span><i class="bi bi-square-fill text-success"></i> İştirak</span>
                        <span><i class="bi bi-square-fill text-info"></i> İreliləyiş</span>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4" data-aos="fade-right" data-aos-delay="80">
                <div class="student-sidebar-card">
                    <div class="student-card-head">
                        ...
                        <span class="student-card-note">Ümumi göstərici</span>
                    </div>
                    <div class="student-sidebar-list">
                        ...
                        <div class="student-sidebar-item"><span
                                class="sidebar-bullet bullet-green"></span><span>Məzun</span><strong><%= graduatedStudents %>
                        </strong></div>
                    ...
                    <div class="student-card-head mt-4">
                        <h5 class="mb-1">İxtisas</h5>
                        <span class="student-card-note">Mövcud quruplar</span>
                    </div>
                    <div class="student-sidebar-list">
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-blue"></span><span>Java Proqramlaşdırma</span><strong><%= javaStudents %>
                        </strong></div>
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-cyan"></span><span>Data Analitikası</span><strong><%= analyticsStudents %>
                        </strong></div>
            ...
            <div class="col-xl-9 col-lg-8" data-aos="fade-up" data-aos-delay="100">
                <div class="card custom-table-card border-0 student-list-card" id="studentTableCard">
                        ...
                        <div class="student-table-topbar">
                            <div class="student-table-title">
                                <h5 class="fw-bold mb-0 text-dark d-flex align-items-center gap-2">
                                    <i class="bi bi-table text-primary"></i> Tələbə Siyahısı
                                    <span class="badge bg-primary-subtle text-primary ms-1 rounded-pill"
                                          style="font-size:0.75rem;"><%= totalAllStudents %> nəfər</span>
                                </h5>
                            </div>
                            <div class="student-table-actions">
                                <div class="d-flex gap-2 flex-wrap justify-content-lg-end">
                                    ...
                                    <button class="btn btn-primary btn-add-new px-4 py-2 shadow-sm"
                                            ...
                                            class="bi bi-person-plus-fill me-2"></i>Yeni Tələbə
                                    </button>
                                    <div class="table-toolbar d-none d-md-flex">
                                        <button class="btn-toolbar-action" title="Export"
                                                onclick="openExportModal('studentTable','Tələbə Siyahısı','Tələbəler',<%= totalAllStudents %>, getStudentExportData())">
                                            <i class="bi bi-box-arrow-up text-primary"></i> Export
                                        </button>
                                        <button class="btn-toolbar-action"
                                                onclick="printTable('#studentTable','Tələbə Siyahısı')" title="Cap et">
                    ...
                    <div class="edu-smart-toolbar">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <button class="edu-qf active" data-filter="all" onclick="studentFilter(this,'all')"><i
                                    class="bi bi-grid-3x3-gap-fill"></i> Hamısı <span class="edu-fc"
                            ...
                            <button class="edu-qf" data-filter="graduated" onclick="studentFilter(this,'graduated')"><i
                                    class="bi bi-mortarboard"></i> Məzun <span class="edu-fc" id="sfc-grad">-</span>
                            </button>
                            <button class="edu-qf" data-filter="paused" onclick="studentFilter(this,'paused')"><i
                                    class="bi bi-pause-circle"></i> Fasilə <span class="edu-fc" id="sfc-pause">-</span>
                            </button>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <div class="dropdown">
                                <button class="edu-tool-btn" data-bs-toggle="dropdown" title="Sütünları idarə et"><i
                                        class="bi bi-layout-three-columns"></i></button>
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 p-2"
                                    style="min-width:200px">
                                    <li><h6 class="dropdown-header small fw-bold text-muted">SÜTÜNLAR</h6></li>
                                    ...
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox"
                                                                                        ...
                                                                                        data-colidx="3"
                                                                                        data-export-index="3"
                                                                                        data-label="Yaş" checked>
                                        Yaş</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox"
                                                                                        class="form-check-input m-0 edu-col-chk"
                                                                                        data-colidx="4"
                                                                                        data-export-index="4"
                                                                                        data-label="İxtisas" checked>
                                        İxtisas</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox"
                                                                                        class="form-check-input m-0 edu-col-chk"
                                                                                        data-colidx="5"
                            ...
                            <div class="dropdown">
                                <button class="edu-tool-btn" data-bs-toggle="dropdown" title="Sıra sıxlığı"><i
                            ...
                            <button class="edu-tool-btn" data-bs-toggle="popover" data-bs-placement="left"
                                    ...
                                    data-bs-content="<div style='font-size:12px'><div class='d-flex justify-content-between gap-3 mb-2'><kbd>Alt+N</kbd><span class='text-muted'>Yeni Tələbə</span></div><div class='d-flex justify-content-between gap-3'><kbd>Esc</kbd><span class='text-muted'>Modali bagla</span></div></div>"
                                    title="Qısayollar"><i class="bi bi-keyboard"></i></button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="student-table table table-hover align-middle mb-0 responsive-table sortable-table"
                            ...
                            <tr>
                                ...
                                <th class="col-student" data-sort>Tələbə</th>
                                <th class="text-center col-email" style="display:none;">Email</th>
                                <th class="text-center col-age" data-sort>Yaş</th>
                                <th class="text-center col-subject">İxtisas</th>
                                ...
                                <td colspan="7" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-muted mb-0">
                                            ...
                                            <% } else { %>
                                            Hele hec bir Tələbə elave edilmeyib.
                                            <% } %>
                                        </p>
                                    </div>
                                </td>
                            ...
                            %>
                            <tr class="stagger-item row-clickable" data-sid="<%= student.getId() %>"
                                data-export-email="<%= student.getEmail() %>" data-status="active">
                    ...
                    <div class="card-footer bg-white border-0 px-4 py-3">
                        <nav aria-label="Tələbə sehifelemesi">
                    ...
                    <div class="edu-status-bar">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="edu-live-wrap"><span class="edu-live-dot"></span><span class="edu-sb-item"
                                                                                                style="font-size:11px">Canlı</span></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-0 px-4 pt-4 pb-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0">Yeni Tələbə Elave Et</h5>
                </div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-0 px-4 pt-4 pb-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="modal-title fw-bold mb-0">Tələbəni Redakte Et</h5>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-4 pb-4">
...
<script>
    ...
    function studentFilter(btn, type) {
        ...
        const lblMap = {
            all: 'Filtr yoxdur',
            active: 'Aktiv Tələbəler',
            graduated: 'Məzunlar',
            paused: 'Fasiledeki Tələbəler'
        };
    ...
    function getStudentExportData() {
        return {
            ...
            dataRows: [
                    ...
                    "<%= exportStudent.getSpecialty() %>",
                    "<%= exportStudent.getStatus() %>"
    ...
    document.getElementById('studentTable').addEventListener('click', function (event) {
        ...
        viewBtn.setAttribute('title', shouldPause ? 'Tələbəni aktiv et' : 'Statusu deaktiv et');
    ...
    /* ─── Sıra klikinə görə student-page.jsp-ə yönləndir ─── */
