            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="50">
                <div class="student-analytics-card student-distribution-card">
                    ...
                    <div class="student-distribution-wrap">
                        <div class="student-distribution-chart" style="--seg-a:<%= activeStudents %>; --seg-b:<%= graduatedStudents %>; --seg-c:<%= passiveStudents %>;">
                            <div class="student-distribution-center">
                                <strong><%= totalAllStudents %></strong>
                                <span>Telebe</span>
                            </div>
                        </div>
                        <div class="student-distribution-legend">
                            <div class="distribution-item"><span class="distribution-dot dot-blue"></span><span>Aktiv <strong><%= activeStudents %></strong></span></div>
                            <div class="distribution-item"><span class="distribution-dot dot-green"></span><span>Mezun <strong><%= graduatedStudents %></strong></span></div>
                            <div class="distribution-item"><span class="distribution-dot dot-orange"></span><span>Diger aktiv <strong><%= passiveStudents %></strong></span></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="student-analytics-card student-performance-card">
                    ...
                    <div class="student-performance-chart">
                        ...
                        <div class="chart-line line-primary">
                            <span style="left:0%;bottom:58%;"></span><span style="left:16%;bottom:46%;"></span><span style="left:32%;bottom:62%;"></span><span style="left:48%;bottom:54%;"></span><span style="left:64%;bottom:69%;"></span><span style="left:80%;bottom:57%;"></span><span style="left:96%;bottom:76%;"></span>
                        </div>
                        <div class="chart-line line-success">
                            <span style="left:0%;bottom:42%;"></span><span style="left:16%;bottom:35%;"></span><span style="left:32%;bottom:49%;"></span><span style="left:48%;bottom:60%;"></span><span style="left:64%;bottom:48%;"></span><span style="left:80%;bottom:54%;"></span><span style="left:96%;bottom:44%;"></span>
                        </div>
                        <div class="chart-line line-info">
                            <span style="left:0%;bottom:66%;"></span><span style="left:16%;bottom:57%;"></span><span style="left:32%;bottom:53%;"></span><span style="left:48%;bottom:68%;"></span><span style="left:64%;bottom:63%;"></span><span style="left:80%;bottom:50%;"></span><span style="left:96%;bottom:72%;"></span>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4" data-aos="fade-right" data-aos-delay="80">
                <div class="student-sidebar-card">
                    ...
                    <div class="student-sidebar-list">
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-blue"></span><span>Davam edir</span><strong><%= activeStudents %></strong></div>
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-green"></span><span>Mezun</span><strong><%= graduatedStudents %></strong></div>
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-slate"></span><span>Qeyri-aktiv</span><strong><%= passiveStudents %></strong></div>
                    </div>
                    ...
                    <div class="student-sidebar-list">
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-blue"></span><span>Java Proqramlasdirma</span><strong><%= javaStudents %></strong></div>
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-cyan"></span><span>Data Analitikasi</span><strong><%= analyticsStudents %></strong></div>
                        <div class="student-sidebar-item"><span class="sidebar-bullet bullet-indigo"></span><span>UI/UX Dizayn</span><strong><%= designStudents %></strong></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-table-card border-0 student-list-card" id="studentTableCard">
                        ...
                        <div class="student-table-topbar">
                            <div class="student-table-title">
                                <h5 class="fw-bold mb-0 text-dark d-flex align-items-center gap-2">
                                    ...
                                    <span class="badge bg-primary-subtle text-primary ms-1 rounded-pill" style="font-size:0.75rem;"><%= totalStudents %> nefer</span>
                                </h5>
                            </div>
                                ...
                                <div class="d-flex gap-2 flex-wrap justify-content-lg-end">
                                    <form action="students.jsp" method="get" class="d-flex gap-2 flex-grow-1">
                                        <div class="input-group search-group flex-grow-1 student-search-box">
                                            ...
                                            <input type="text" name="search" value="<%= search != null ? search : "" %>" class="form-control border-start-0 border-end-0 py-2" placeholder="Ad ve ya soyad ile axtar...">
                                            <button type="submit" class="btn btn-primary rounded-end-pill px-4">Axtar</button>
                                        </div>
                                        <% if (search != null && !search.trim().isEmpty()) { %>
                                        <a href="students.jsp" class="btn btn-outline-secondary rounded-pill px-3" title="Sifirla"><i class="bi bi-x-lg"></i></a>
                                        <% } %>
                                    </form>
                                    <button class="btn btn-primary btn-add-new px-4 py-2 shadow-sm" data-bs-toggle="modal" data-bs-target="#addStudentModal"><i class="bi bi-person-plus-fill me-2"></i>Yeni Telebe</button>
                                    <div class="table-toolbar d-none d-md-flex">
                                        <button class="btn-toolbar-action" title="Export" onclick="openExportModal('studentTable','Telebe Siyahisi','telebeler',<%= totalAllStudents %>, getStudentExportData())"><i class="bi bi-box-arrow-up text-primary"></i> Export</button>
                                        <button class="btn-toolbar-action" onclick="printTable('#studentTable','Telebe Siyahisi')" title="Cap et"><i class="bi bi-printer"></i></button>
                                    </div>
                                    <div class="table-toolbar d-flex d-md-none mt-2">
                                        <button class="btn-toolbar-action w-100" title="Export" onclick="openExportModal('studentTable','Telebe Siyahisi','telebeler',<%= totalAllStudents %>, getStudentExportData())"><i class="bi bi-box-arrow-up text-primary"></i> Export</button>
                                        <button class="btn-toolbar-action w-100" onclick="printTable('#studentTable','Telebe Siyahisi')" title="Cap et"><i class="bi bi-printer"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="edu-smart-toolbar">
                        <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <button class="edu-qf active" data-filter="all" onclick="studentFilter(this,'all')"><i class="bi bi-grid-3x3-gap-fill"></i> Hamisi <span class="edu-fc" id="sfc-all"><%= totalStudents %></span></button>
                            <button class="edu-qf" data-filter="active" onclick="studentFilter(this,'active')"><i class="bi bi-circle-fill" style="color:#10b981;font-size:7px;vertical-align:middle;"></i> Aktiv <span class="edu-fc" id="sfc-active">-</span></button>
                            <button class="edu-qf" data-filter="graduated" onclick="studentFilter(this,'graduated')"><i class="bi bi-mortarboard"></i> Mezun <span class="edu-fc" id="sfc-grad">-</span></button>
                            <button class="edu-qf" data-filter="paused" onclick="studentFilter(this,'paused')"><i class="bi bi-pause-circle"></i> Fasile <span class="edu-fc" id="sfc-pause">-</span></button>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <div class="dropdown">
                                <button class="edu-tool-btn" data-bs-toggle="dropdown" title="Sutunlari idare et"><i class="bi bi-layout-three-columns"></i></button>
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 p-2" style="min-width:200px">
                                    ...
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox" class="form-check-input m-0 edu-col-chk" data-colidx="0" data-export-index="0" data-label="ID" checked> ID</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox" class="form-check-input m-0 edu-col-chk" data-colidx="1" data-export-index="1" data-label="Telebe" checked> Telebe</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox" class="form-check-input m-0 edu-col-chk" data-colidx="2" data-export-index="2" data-label="Email"> Email</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox" class="form-check-input m-0 edu-col-chk" data-colidx="3" data-export-index="3" data-label="Yas" checked> Yas</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox" class="form-check-input m-0 edu-col-chk" data-colidx="4" data-export-index="4" data-label="Ixtisas" checked> Ixtisas</label></li>
                                    <li><label class="dropdown-item edu-col-lbl"><input type="checkbox" class="form-check-input m-0 edu-col-chk" data-colidx="5" data-export-index="5" data-label="Status" checked> Status</label></li>
                                </ul>
                            </div>
                            <div class="dropdown">
                                <button class="edu-tool-btn" data-bs-toggle="dropdown" title="Sira sixligi"><i class="bi bi-distribute-vertical"></i></button>
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 p-2">
                                    ...
                                    <li><button class="dropdown-item rounded-2 py-2" onclick="stuDensity('compact')"><i class="bi bi-list me-2"></i>Kompakt</button></li>
                                    <li><button class="dropdown-item rounded-2 py-2 fw-semibold" onclick="stuDensity('normal')"><i class="bi bi-view-list me-2"></i>Normal</button></li>
                                    <li><button class="dropdown-item rounded-2 py-2" onclick="stuDensity('comfortable')"><i class="bi bi-card-list me-2"></i>Genis</button></li>
                                </ul>
                            </div>
                            <button class="edu-tool-btn" id="stuFsBtn" onclick="stuFullscreen()" title="Tam ekran"><i class="bi bi-fullscreen" id="stuFsIcon"></i></button>
                            <button class="edu-tool-btn" data-bs-toggle="popover" data-bs-placement="left" data-bs-trigger="click" data-bs-html="true" data-bs-content="<div style='font-size:12px'><div class='d-flex justify-content-between gap-3 mb-2'><kbd>Alt+N</kbd><span class='text-muted'>Yeni telebe</span></div><div class='d-flex justify-content-between gap-3'><kbd>Esc</kbd><span class='text-muted'>Modali bagla</span></div></div>" title="Qisayollar"><i class="bi bi-keyboard"></i></button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="student-table table table-hover align-middle mb-0 responsive-table sortable-table" id="studentTable">
                            <thead>
                            <tr>
                                ...
                                <td colspan="7" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <p class="text-muted mb-0">
                                            <% if (search != null && !search.trim().isEmpty()) { %>
                                            "<strong><%= search %></strong>" uzre netice tapilmadi.
                                            <% } else { %>
                            ...
                            <tr class="stagger-item" data-export-email="<%= student.getEmail() %>" data-status="active">
                                ...
                                <td data-export="<%= student.getName() %> <%= student.getSurname() %>">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="avatar-circle bg-primary text-white flex-shrink-0"><%= initials %></div>
                                        <div>
                                            <div class="fw-semibold text-dark lh-sm"><%= student.getName() %> <%= student.getSurname() %></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center col-email" style="display:none;" data-export="<%= student.getEmail() %>"><span class="text-muted small"><%= student.getEmail() %></span></td>
                                <td class="text-center"><span class="age-badge"><%= student.getAge() %></span></td>
                                <td class="text-center"><span class="badge rounded-pill px-3 py-2 subject-badge"><i class="bi bi-code-slash me-1"></i>Java Proqramlasdirma</span></td>
                                <td class="text-center"><span class="badge badge-soft-success rounded-pill px-3 py-2 student-status-badge"><i class="bi bi-circle-fill me-1" style="font-size:6px;"></i>Davam edir</span></td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button class="btn btn-action btn-view shadow-sm" title="Statusu deaktiv et"><i class="bi bi-eye"></i></button>
                                        <button class="btn btn-action btn-edit shadow-sm" title="Redakte et" data-bs-toggle="modal" data-bs-target="#editStudentModal" data-id="<%= student.getId() %>" data-name="<%= student.getName() %>" data-surname="<%= student.getSurname() %>" data-age="<%= student.getAge() %>" data-email="<%= student.getEmail() %>"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-action btn-delete shadow-sm" title="Sil" data-bs-toggle="modal" data-bs-target="#deleteStudentModal" data-id="<%= student.getId() %>" data-name="<%= student.getName() %> <%= student.getSurname() %>"><i class="bi bi-trash3"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <%
                    ...
                    <div class="card-footer bg-white border-0 px-4 py-3">
                        <nav aria-label="Telebe sehifelemesi">
                            <ul class="pagination pagination-sm justify-content-center mb-0" id="pagination-student">
                                <li class="page-item"><a class="page-link rounded-circle me-1 border-0 bg-light" href="#" id="prev-student"><i class="bi bi-chevron-left"></i></a></li>
                                <li class="page-item"><a class="page-link rounded-circle border-0 bg-light" href="#" id="next-student"><i class="bi bi-chevron-right"></i></a></li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="edu-status-bar">
                        <div class="d-flex align-items-center gap-3">
                            <span class="edu-sb-item"><i class="bi bi-table text-primary me-1"></i><span id="stu-visible-count"><%= totalStudents %></span> setir</span>
                            <span class="edu-sb-sep">|</span>
                            <span class="edu-sb-item"><i class="bi bi-funnel text-muted me-1"></i><span id="stu-filter-label">Filtr yoxdur</span></span>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <span class="edu-sb-item text-muted"><i class="bi bi-clock me-1"></i><span id="stu-load-time"></span></span>
                            <span class="edu-live-wrap"><span class="edu-live-dot"></span><span class="edu-sb-item" style="font-size:11px">Canli</span></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body px-4 pb-4">
                <form action="student" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control rounded-3 px-3" placeholder="Mes: Sukur" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label small fw-semibold text-muted">Soyad</label>
                        <input type="text" name="surname" class="form-control rounded-3 px-3" placeholder="Mes: Agayev" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-6">
                            <label class="form-label small fw-semibold text-muted">Yas</label>
                            <input type="number" name="age" class="form-control rounded-3 px-3" placeholder="Mes: 22" min="14" max="80" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-6">
                            <label class="form-label small fw-semibold text-muted">Email</label>
                            <input type="email" name="email" class="form-control rounded-3 px-3" placeholder="sukur@email.com" required>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary w-100 rounded-3 py-2 mt-2 fw-semibold"><i class="bi bi-check2-circle me-2"></i>Yadda Saxla</button>
                </form>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body px-4 pb-4">
                <form action="student" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="edit-student-id-display" class="form-control rounded-3 px-3 bg-light text-muted" disabled>
                    </div>
                    <div class="mb-3">
                        <label class="form-label small fw-semibold text-muted">Ad</label>
                        <input type="text" name="name" id="edit-student-name" class="form-control rounded-3 px-3" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label small fw-semibold text-muted">Soyad</label>
                        <input type="text" name="surname" id="edit-student-surname" class="form-control rounded-3 px-3" required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-6">
                            <label class="form-label small fw-semibold text-muted">Yas</label>
                            <input type="number" name="age" id="edit-student-age" class="form-control rounded-3 px-3" min="14" max="80" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-6">
                            <label class="form-label small fw-semibold text-muted">Email</label>
                            <input type="email" name="email" id="edit-student-email" class="form-control rounded-3 px-3" required>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-warning w-100 rounded-3 py-2 mt-2 fw-semibold text-white"><i class="bi bi-arrow-repeat me-2"></i>Yenile</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-body p-4 text-center">
                ...
                <p class="text-muted mb-4"><span class="fw-semibold text-dark" id="delete-student-name"></span> adli telebeni silmek istediyinize eminsiniz?</p>
                <form action="student" method="POST">
                    <input type="hidden" name="action" value="delete">
                    <input type="hidden" name="id" id="delete-student-id">
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-light w-100 rounded-3 py-2" data-bs-dismiss="modal">Legv Et</button>
                        <button type="submit" class="btn btn-danger w-100 rounded-3 py-2 fw-semibold"><i class="bi bi-trash3 me-1"></i>Sil</button>
                    </div>
                </form>
            </div>
        </div>
...
function studentFilter(btn, type) {
    ...
    _stuAllRows.forEach(r => { if (!tbody.contains(r)) tbody.appendChild(r); });
    if (type !== 'all') {
    ...
    const lblMap = { all:'Filtr yoxdur', active:'Aktiv telebeler', graduated:'Mezunlar', paused:'Fasiledeki telebeler' };
